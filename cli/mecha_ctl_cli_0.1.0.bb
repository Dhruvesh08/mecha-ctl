...
# how to get mecha_ctl_cli could be as easy as but default to a git checkout:
# SRC_URI += "crate://crates.io/mecha_ctl_cli/0.1.0"
SRC_URI += "git://git@github.com/dhruveshb-mecha/mecha-ctl.git;protocol=ssh;nobranch=1;branch=main"
SRCREV = "4b3e5a76468bfa79b8ca84a4896a1d427db803bd"
S = "${WORKDIR}/git"
CARGO_SRC_DIR = "cli"
PV:append = ".AUTOINC+4b3e5a7646"
...
include mecha_ctl_cli-${PV}.inc
include mecha_ctl_cli.inc
